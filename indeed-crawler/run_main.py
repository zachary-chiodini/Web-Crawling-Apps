...
queries: List[str] = [
    'filmmaker', 'Film Producer', 'Film Project Manager', 'Production Coordinator'
]
...
negate_jobs: List[str] = [
    'appointment setting', 'appointment'
]

negate_comps: List[str] = [
    'Clirror', 'Cool Kidds Forever', 'Forever Media'
]
...
indeed_crawler.login(
    email='domonique.gay@outlook.com',
